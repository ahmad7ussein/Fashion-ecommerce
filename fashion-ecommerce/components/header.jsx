            ...
            <NavigationMenu>
              <NavigationMenuList>
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <div className="grid w-[550px] gap-2 p-4 md:grid-cols-2">
                      {menCategories.map((category) => (<Link key={category.name} href={category.href} className="group/item block select-none space-y-1 rounded-lg p-3 leading-none no-underline outline-none transition-all duration-300 hover:bg-primary/10 hover:text-primary hover:scale-105 focus:bg-accent focus:text-accent-foreground border border-transparent hover:border-primary/30 hover:shadow-md">
                ...
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <div className="grid w-[550px] gap-2 p-4 md:grid-cols-2">
                      {womenCategories.map((category) => (<Link key={category.name} href={category.href} className="group/item block select-none space-y-1 rounded-lg p-3 leading-none no-underline outline-none transition-all duration-300 hover:bg-primary/10 hover:text-primary hover:scale-105 focus:bg-accent focus:text-accent-foreground border border-transparent hover:border-primary/30 hover:shadow-md">
                          <div className="text-sm font-medium leading-none relative z-10">
                            {category.name}
                          </div>
                          <div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-transparent opacity-0 group-hover/item:opacity-100 transition-opacity duration-300 rounded-lg"/>
                ...
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <div className="grid w-[550px] gap-2 p-4 md:grid-cols-2">
                      {kidsCategories.map((category) => (<Link key={category.name} href={category.href} className="group/item block select-none space-y-1 rounded-lg p-3 leading-none no-underline outline-none transition-all duration-300 hover:bg-primary/10 hover:text-primary hover:scale-105 focus:bg-accent focus:text-accent-foreground border border-transparent hover:border-primary/30 hover:shadow-md">
                          <div className="text-sm font-medium leading-none relative z-10">
                            {category.name}
                          </div>
                          <div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-transparent opacity-0 group-hover/item:opacity-100 transition-opacity duration-300 rounded-lg"/>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/cart">
              <Button variant="ghost" size="icon" className="relative group hover:scale-110 transition-all duration-300 text-gray-900 hover:text-rose-600">
                ...
                {itemCount > 0 && (<Badge className="absolute -top-1 -right-1 h-5 w-5 p-0 flex items-center justify-center text-xs bg-primary animate-pulse">
            ...
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-[320px] sm:w-[400px] overflow-y-auto">
                ...
                <nav className="flex flex-col gap-2 mt-6">
                  <Accordion type="multiple" className="w-full">
                    ...
                    <AccordionItem value="men" className="border-b">
                      ...
                      <AccordionContent className="pb-2">
                        <div className="grid grid-cols-2 gap-2 px-3">
                          {menCategories.map((category) => (<Link key={category.name} href={category.href} onClick={() => setMobileMenuOpen(false)} className="block px-3 py-2.5 text-sm rounded-lg hover:bg-primary/10 hover:text-primary transition-all duration-300 hover:scale-105 border border-transparent hover:border-primary/30 hover:shadow-md">
                              {category.name}
                            </Link>))}
                        </div>
                      </AccordionContent>
                    ...
                    <AccordionItem value="women" className="border-b">
                      ...
                      <AccordionContent className="pb-2">
                        <div className="grid grid-cols-2 gap-2 px-3">
                          {womenCategories.map((category) => (<Link key={category.name} href={category.href} onClick={() => setMobileMenuOpen(false)} className="block px-3 py-2.5 text-sm rounded-lg hover:bg-primary/10 hover:text-primary transition-all duration-300 hover:scale-105 border border-transparent hover:border-primary/30 hover:shadow-md">
                              {category.name}
                            </Link>))}
                        </div>
                      </AccordionContent>
                    ...
                    <AccordionItem value="kids" className="border-b">
                      ...
                      <AccordionContent className="pb-2">
                        <div className="grid grid-cols-2 gap-2 px-3">
                          {kidsCategories.map((category) => (<Link key={category.name} href={category.href} onClick={() => setMobileMenuOpen(false)} className="block px-3 py-2.5 text-sm rounded-lg hover:bg-primary/10 hover:text-primary transition-all duration-300 hover:scale-105 border border-transparent hover:border-primary/30 hover:shadow-md">
                              {category.name}
                            </Link>))}
                        </div>
                      </AccordionContent>
                  ...
                  <div className="border-t pt-4 mt-2 space-y-1">
                    <Link href="/products" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-3 py-3 text-sm font-semibold rounded-lg hover:bg-primary/10 hover:text-primary transition-all duration-300 hover:scale-105 hover:shadow-md">
                      <Package className="h-4 w-4"/>
                      {t("allProducts")}
                    </Link>
                    <Link href="/new-arrival" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-3 py-3 text-sm font-semibold rounded-lg hover:bg-primary/10 hover:text-primary transition-all duration-300 hover:scale-105 hover:shadow-md">
                      {language === "ar" ? "وصل جديد" : "New Arrival"}
                    </Link>
                    <Link href="/collection" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-3 py-3 text-sm font-semibold rounded-lg hover:bg-primary/10 hover:text-primary transition-all duration-300 hover:scale-105 hover:shadow-md">
                      {language === "ar" ? "المجموعة" : "Collection"}
                    </Link>
                    <Link href="/studio" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-3 py-3 text-sm font-semibold rounded-lg hover:bg-primary/10 hover:text-primary transition-all duration-300 hover:scale-105 hover:shadow-md">
                      {t("designStudio")}
                    </Link>
                  </div>
                  {user && (<div className="border-t pt-4 space-y-2">
                ...
                .slice(0, 2)}
                      ...
                      <Link href="/profile" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-md hover:bg-accent">
                        <UserCircle2 className="h-4 w-4"/>
                        {t("myProfile")}
                      </Link>
                      <Link href="/profile?tab=orders" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-md hover:bg-accent">
                        <Package className="h-4 w-4"/>
                        {t("myOrders")}
                      </Link>
                      <Link href="/profile?tab=designs" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-md hover:bg-accent">
