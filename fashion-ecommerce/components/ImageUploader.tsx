  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-col items-center gap-3">
        <button
          onClick={handleClick}
          className="w-16 h-16 rounded-xl border-2 border-dashed border-primary/40 bg-primary/5 flex items-center justify-center hover:bg-primary/10 hover:border-primary/60 transition-all group"
        >
          {uploadedImage ? (
        ...
        {uploadedImage && onImageSizeChange && (
          <div className="w-full max-w-xs space-y-2">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => onImageSizeChange(Math.max(30, imageSize - 10))}
              ...
              <button
                onClick={() => onImageSizeChange(Math.min(200, imageSize + 10))}
                className="p-1 rounded bg-muted hover:bg-muted/80 transition-colors"
              >
