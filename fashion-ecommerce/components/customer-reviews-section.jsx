...
export function CustomerReviewsSection() {
    ...
    return (<section className="py-20 sm:py-24 md:py-32 bg-gradient-to-b from-white via-rose-50/30 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            return (<motion.div key={review._id} initial={{ opacity: 0, y: 50, scale: 0.95 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} viewport={{ once: true }} transition={{
                    duration: 0.6,
                    delay: index * 0.1,
                    ease: [0.22, 1, 0.36, 1]
                }} whileHover={{
                  ...
                  <div className={`relative h-full ${cardVariants[index % cardVariants.length]} rounded-3xl p-6 sm:p-8 border-2 border-rose-100/50 hover:border-rose-300 hover:shadow-2xl transition-all duration-300 group`}>
                    ...
                    <div className="flex gap-1 mb-4 relative z-10">
                      {[1, 2, 3, 4, 5].map((star) => (<Star key={star} className={`h-5 w-5 transition-all ${star <= review.rating
                    ...
                    <div className="mt-auto pt-6 border-t border-rose-200/50 relative z-10">
                      ...
                      {review.adminResponse && (<div className="mt-4 p-3 bg-rose-50/50 rounded-xl border border-rose-100">
