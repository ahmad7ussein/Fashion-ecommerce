                      ...
                      <Link href={`/products/${productId}`}>
                        <Card className="overflow-hidden bg-white border-2 border-gray-200 hover:border-rose-300 hover:shadow-2xl transition-all duration-500 rounded-2xl h-full flex flex-col relative">
                          ...
                          <div className="aspect-square overflow-hidden bg-gradient-to-br from-rose-50 to-pink-50 relative">
                            ...
                            <Button
                              variant="ghost"
                              className={`absolute top-3 right-3 h-9 px-3 rounded-full border shadow-lg z-10 transition-all flex items-center gap-1 text-[11px] font-semibold ${isFavorite ? "border-rose-500 bg-rose-50 text-rose-600" : "border-gray-200 bg-white/90 text-gray-600 hover:border-rose-300 hover:text-rose-500"}`}
