...
export default function EmployeeLoginPage() {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-blue-900 flex items-center justify-center p-4">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Input id="password" type="password" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} required className="bg-blue-700 border-blue-600 text-white placeholder:text-blue-300"/>
              </div>
