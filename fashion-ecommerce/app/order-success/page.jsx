        ...
        <Card className="bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl rounded-3xl">
          <CardContent className="p-6 md:p-8">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="space-y-3">
              ...
              <Button asChild className="w-full bg-white text-black hover:bg-gray-200 rounded-full h-12 text-base font-semibold transition-all duration-300 hover:scale-105 shadow-lg">
              ...
              <Button asChild variant="outline" className="w-full border-2 border-white/20 bg-white/5 hover:bg-white/10 hover:border-white/30 text-white rounded-full h-12 text-base font-semibold transition-all duration-300 hover:scale-105">
                <Link href="/">
              ...
              <Button onClick={handleLogout} variant="ghost" className="w-full text-gray-400 hover:text-white hover:bg-white/5 rounded-full h-10 text-sm transition-all duration-300">
