      ...
      <div className="flex-1 flex items-center justify-center p-6 overflow-auto">
        <div className="relative" style={{
          ...
          <div className="relative" style={{
            ...
            <img src={currentImage} alt={`${productType} ${currentSide}`} className="w-[400px] h-auto object-contain" style={{
            ...
            {safeArea && safeArea.width > 0 && safeArea.height > 0 && (<div className="absolute pointer-events-none border-2 border-dashed border-rose-400/80 bg-rose-200/10" style={{
                left: `${safeArea.x}px`,
                top: `${safeArea.y}px`,
            ...
            if (element.type === "text") {
                return (<div key={element.id} className="absolute" style={{
                        left: `${element.x}px`,
                        top: `${element.y}px`,
                ...
                return (<img key={element.id} src={element.content} alt="Design element" className="absolute" style={{
                        left: `${element.x}px`,
                        top: `${element.y}px`,
                        transform: element.rotation ? `rotate(${element.rotation}deg)` : undefined,
                        opacity: element.opacity || 1,
