...
import { suppliersApi, type Supplier, type SupplierProduct, type SupplierAnalytics } from "@/lib/api/suppliers"
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            ...
            <Input
              ...
              onChange={(event) => setSupplierForm({ ...supplierForm, contactEmail: event.target.value })}
            />
            <Input
              placeholder="Contact phone"
              value={supplierForm.contactPhone}
              onChange={(event) => setSupplierForm({ ...supplierForm, contactPhone: event.target.value })}
            />
            <Input
              type="number"
              placeholder="Commission rate (%)"
              value={supplierForm.commissionRate}
              onChange={(event) => setSupplierForm({ ...supplierForm, commissionRate: event.target.value })}
            />
            <Input
              placeholder="Delivery time"
              value={supplierForm.deliveryTime}
              onChange={(event) => setSupplierForm({ ...supplierForm, deliveryTime: event.target.value })}
            />
            <Textarea
              placeholder="Return policy"
              value={supplierForm.returnPolicy}
              onChange={(event) => setSupplierForm({ ...supplierForm, returnPolicy: event.target.value })}
            />
            <Input
              type="number"
              placeholder="Rating average"
              value={supplierForm.ratingAverage}
              onChange={(event) => setSupplierForm({ ...supplierForm, ratingAverage: event.target.value })}
            />
            <Input
              type="number"
              placeholder="Rating count"
              value={supplierForm.ratingCount}
              onChange={(event) => setSupplierForm({ ...supplierForm, ratingCount: event.target.value })}
            />
          </div>
