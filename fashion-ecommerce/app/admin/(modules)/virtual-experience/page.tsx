...
import { featureControlsApi, type VirtualExperienceSettings } from "@/lib/api/featureControls"
...
export default function VirtualExperienceControlPage() {
  const { user } = useAuth()
  const [settings, setSettings] = useState<VirtualExperienceSettings | null>(null)
    ...
    <div className="p-6">
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Textarea
            placeholder="Supported product IDs (comma separated)"
            value={settings.supportedProductIds.join(", ")}
            onChange={(event) =>
              setSettings({
                ...settings,
          ...
          <Textarea
            ...
            value={settings.supportedCategories.join(", ")}
            onChange={(event) =>
              setSettings({
                ...settings,
