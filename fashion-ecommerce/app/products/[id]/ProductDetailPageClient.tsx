            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  ...
                  className="bg-gradient-to-r from-rose-500 to-pink-500 text-white hover:from-rose-600 hover:to-pink-600 rounded-full font-semibold px-8 py-6 text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-rose-200"
                >
                ...
                <Button
                  ...
                  className="border-gray-300 bg-white hover:bg-rose-50 hover:border-rose-300 rounded-full font-semibold px-8 py-6 text-lg transition-all duration-300"
                >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 max-w-7xl mx-auto">
          ...
          >
            <div className="aspect-square overflow-hidden rounded-2xl bg-white border-2 border-gray-200 relative shadow-xl">
              <Image
                src={images[selectedImage] || "/placeholder-logo.png"}
              ...
              <div className="flex gap-2 md:gap-3 overflow-x-auto pb-2" style={{ scrollbarWidth: 'thin', scrollbarColor: '#fda4af #f3f4f6' }}>
                {images.map((image, index) => (
                  <button
                    ...
                    className={`flex-shrink-0 aspect-square overflow-hidden rounded-lg bg-white border-2 transition-all duration-300 relative cursor-pointer ${
                      selectedImage === index 
                  ...
                  >
                    <Image
                      ...
                      alt={`${productData.name} ${language === "ar" ? "صورة" : "image"} ${index + 1}`}
                      fill
                      className="object-cover"
                      sizes="80px"
                    />
          ...
          >
            <div>
              ...
              {(productData as any).onSale && (productData as any).salePercentage ? (
                <div className="space-y-2">
                  <div className="flex items-center gap-3">
                    <Badge className="bg-red-500 text-white text-sm sm:text-base px-3 py-1">
                      {language === "ar" ? `خصم ${(productData as any).salePercentage}%` : `${(productData as any).salePercentage}% OFF`}
                    </Badge>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-rose-500 via-pink-500 to-rose-600 bg-clip-text text-transparent">
                      {formatPrice(productData.price * (1 - ((productData as any).salePercentage || 0) / 100))}
                    </span>
                  </div>
                </div>
              ) : (
                <p className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-rose-500 via-pink-500 to-rose-600 bg-clip-text text-transparent">{formatPrice(productData.price)}</p>
              )}
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <Button 
                  ...
                  className="border-gray-300 bg-white hover:bg-rose-50 hover:border-rose-300 text-gray-700 h-9 w-9 sm:h-10 sm:w-10"
                >
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-2">
              <Button 
                size="lg" 
                className="flex-1 bg-gradient-to-r from-rose-500 to-pink-500 text-white hover:from-rose-600 hover:to-pink-600 rounded-full font-semibold h-11 sm:h-12 md:h-14 text-sm sm:text-base md:text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-rose-200" 
              ...
              <Button 
                size="lg" 
                variant="outline"
                className={`border-gray-300 bg-white hover:bg-rose-50 rounded-full h-11 sm:h-12 md:h-14 w-full sm:w-11 sm:w-12 md:w-14 transition-all ${
                  isFavorite ? "border-rose-500 bg-rose-50" : "hover:border-rose-300"
                }`}
            ...
            <Card className="p-4 sm:p-5 md:p-6 bg-white border-2 border-gray-200 rounded-xl sm:rounded-2xl shadow-lg">
              ...
              <ul className="space-y-2 sm:space-y-2.5">
                {features.map((feature, index) => (
                  <li key={index} className="flex items-start gap-2 sm:gap-2.5 text-xs sm:text-sm text-gray-600">
                      ...
                      <Link href={`/products/${relatedProductId}`}>
                        <Card className="group overflow-hidden bg-white border-2 border-gray-200 hover:border-rose-300 hover:shadow-xl transition-all duration-500 rounded-2xl h-full flex flex-col shadow-lg">
                          <div className="aspect-square overflow-hidden bg-white relative">
                            <Image
                              src={relatedProduct.image || "/placeholder-logo.png"}
