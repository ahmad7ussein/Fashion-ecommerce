      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24 py-12 sm:py-16">
        ...
        >
          <Card className="p-8 bg-gradient-to-r from-rose-50 to-pink-50 border-2 border-rose-200">
            ...
            <a
              href="/contact"
              className="inline-block px-6 py-3 bg-gradient-to-r from-rose-500 to-pink-500 text-white rounded-lg font-semibold hover:from-rose-600 hover:to-pink-600 transition-all shadow-lg shadow-rose-200"
            >
