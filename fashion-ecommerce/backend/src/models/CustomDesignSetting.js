...
const printAreaSchema = new mongoose_1.Schema({
    name: { type: String, required: true, trim: true },
    width: { type: Number, required: true, min: 1 },
    height: { type: Number, required: true, min: 1 },
    unit: { type: String, default: 'cm' },
}, { _id: false });
const customDesignSettingSchema = new mongoose_1.Schema({
...
exports.default = mongoose_1.default.model('CustomDesignSetting', customDesignSettingSchema);
